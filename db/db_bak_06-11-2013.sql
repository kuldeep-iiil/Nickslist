...
--
-- Table structure for table `paypal_workerrs`
--

DROP TABLE IF EXISTS `paypal_workerrs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `paypal_workerrs` (
...
CREATE TABLE `Customers` (
  ...
  `DateUpdated` datetime NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_CustomersCityID` (`City`),
  KEY `fk_CustomersStateID` (`State`)
...
--
-- Table structure for table `DetailedInfoReviews`
--

DROP TABLE IF EXISTS `DetailedInfoReviews`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `DetailedInfoReviews` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_DetailedReviewID` FOREIGN KEY (`ReviewID`) REFERENCES `Reviews` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `GeneralInfoReviews`
--

DROP TABLE IF EXISTS `GeneralInfoReviews`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `GeneralInfoReviews` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ReviewID` int(11) NOT NULL,
  `QuestionID` int(11) NOT NULL,
  `Comments` text NOT NULL,
  ...
  `DateUpdated` datetime NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_GeneralReviewID` (`ReviewID`),
  KEY `fk_GeneralQuestionID` (`QuestionID`),
  CONSTRAINT `fk_GeneralQuestionID` FOREIGN KEY (`QuestionID`) REFERENCES `ReviewQuestions` (`ID`),
  CONSTRAINT `fk_GeneralReviewID` FOREIGN KEY (`ReviewID`) REFERENCES `Reviews` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Reviews` (
  ...
  `IsApproved` bit(1) NOT NULL,
  `MLAndJudgments` text NOT NULL,
  `OtherPublicThirdPartyInfo` text NOT NULL,
  `DateCreated` datetime NOT NULL,
  `DateUpdated` datetime NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `fk_ReviewsUserID` (`UserID`),
  CONSTRAINT `fk_ReviewsUserID` FOREIGN KEY (`UserID`) REFERENCES `SubscribedUsers` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `paypal_workers`
--

DROP TABLE IF EXISTS `paypal_workers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `paypal_workers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `paypal_interfaces`
--

DROP TABLE IF EXISTS `paypal_interfaces`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `paypal_interfaces` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping events for database 'nickslist_dev'
--

--
-- Dumping routines for database 'nickslist_dev'
--
...
-- Dump completed on 2013-11-06 12:33:25
