...
CREATE TABLE `Reviews` (
  ...
  KEY `fk_ReviewsCustomerID` (`CustomerID`),
  CONSTRAINT `fk_ReviewsCustomerID` FOREIGN KEY (`CustomerID`) REFERENCES `Customers` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2013-11-12 14:44:19
