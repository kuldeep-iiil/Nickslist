class AuthorizePaymentController < ApplicationController
  ...
  def payment
    ...
    @sim_transaction = AuthorizeNet::SIM::Transaction.new(AUTHORIZE_NET_CONFIG['api_login_id'], AUTHORIZE_NET_CONFIG['api_transaction_key'], @amount, :relay_url => "authorize_payment_relay_response_url")
  ...
  def relay_response
    ...
    if sim_response.success?(AUTHORIZE_NET_CONFIG['api_login_id'], AUTHORIZE_NET_CONFIG['merchant_hash_value'])
      render :text => sim_response.direct_post_reply("authorize_payment_receipt_url")
    else
      render :text => sim_response.direct_post_reply("authorize_payment_error_url")
    end
  end
